  ...
  const fetchDataFromDatabase = async () => {
    ...
    if (selectedKrajVypis || selectedOkresVypis) {
      ...
      collectionRef = collectionRef.where(
        selectedKrajVypis === "" ? "District" : "Region",
        "==",
        selectedKrajVypis === "" ? selectedOkresVypis : selectedKrajVypis
      );
    }
      ...
      <article className="form">
        <form>
          ...
          <div className="hledaci-box-1">
            ...
            <input
              type="text"
              placeholder="Celý Email zadavatele"
              onChange={funkceEmail}
              value={inputEmail}
            />
          </div>
          ...
          <div className="hledaci-box-2">
            ...
            <div className="kraj-okres">
              ...
              <div className="kraj">
                ...
                <select
                  name="kraj"
                  value={selectedKrajVypis}
                  onChange={selectedKraj}
                >
              ...
              <div className="okres">
                ...
                <select
                  name="okres"
                  value={selectedOkresVypis}
                  onChange={selectedOkres}
                >
                  <option value="">Vyberte okres:</option>
                  {
                    ...
                    data_seznamOkresu.map((oneOkres) => {
                      ...
                      if (
                        ...
                        return (
                          <React.Fragment key={oneOkres.id}>
                            <optgroup label={oneOkres.idOkresu}></optgroup>
                            <option value={oneOkres.name}>
                              {oneOkres.name}
                            </option>
                          </React.Fragment>
                        );
      ...
      <article className="vypsane-nabídky">
        ...
        {data
          ...
          .map((oneData) => {
            ...
            return (
              <div key={oneData.id} className="jedna-nabídka">
                <h3>{Fullname}</h3>
